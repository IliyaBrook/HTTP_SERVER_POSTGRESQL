...
func CreateUser(w http.ResponseWriter, r *http.Request) {
	...
	utils.HandleServerError(err, w, "Failed to marshal orders data", "test")
	...
	utils.HandleServerError(err, w, "Failed to save database", "test")

	w.WriteHeader(http.StatusCreated)
	resp, err = json.Marshal(&newUser)
	utils.HandleServerError(err, w, "Failed to marshal user data", "test")
